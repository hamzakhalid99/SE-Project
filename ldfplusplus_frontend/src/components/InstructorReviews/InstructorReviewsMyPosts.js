...
import './InstructorReviewsMyPosts.css'
import BACKEND_LINK from './../../env.js';

class InstructorReviewsMyPosts extends React.Component {
    ...
    componentWillMount() {
        fetch(BACKEND_LINK + '/instructorreviews/myposts', {
            method: 'post',
    ...
    onDelete = (post) => {
        fetch(BACKEND_LINK + '/instructorreviews/delete', {
            method: 'post',
            headers: {'Content-Type': 'application/json'},
	...
	render() {
        ...
        return (
            <div>
                ...
                <a className="form-green-button" onClick={() => { onRouteChange('instructorreviews') }}>Back</a>
...
export default InstructorReviewsMyPosts;